...
class Shader {
public:
	Shader(const char* vertPath, const char* fragPath, bool isSprite, int particleType);
	~Shader();
	...
	void makeSprite();
	void makeGrenadeParticles();
	void makeFireParticles();
	void makeIceParticles();

	void createProgram(const char* vertPath, const char* fragPath);

	void SetAttributes_sprite();

	void SetAttributes_particle(int particleType);
...
protected:
	...
	static GLuint vbo_grenade_particle;
	static GLuint ebo_grenade_particle;
	static GLuint vbo_fire_particle;
	static GLuint ebo_fire_particle;
	static GLuint vbo_ice_particle;
	static GLuint ebo_ice_particle;
